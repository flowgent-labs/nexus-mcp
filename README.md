...
export MCP__AUTH__FRONTEND__OIDC__AUDIENCE="nexus-mcp"
...
2. **Static** web token (`auth.backend.static.web_token`)
...
- **GitHub Issues**: [Create an issue](../../nexus-mcp/issues)
- **Discussions**: [Start a discussion](../../nexus-mcp/discussions)
