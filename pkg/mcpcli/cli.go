...
func ListTools() {
	...
	if len(nativeTools) == 0 {
		fmt.Fprintf(os.Stderr, "Warning: no native tools are enabled. To expose native tools, set native_tools.expose.register_all_tools_by_default: true or add tool names to tools.expose.includes in ~/.nexus-mcp/config.yaml\n")
	}
